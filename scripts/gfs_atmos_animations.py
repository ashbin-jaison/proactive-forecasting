...
from skyfora.data import open_opendap_dataset, get_gfs_opendap_url, get_latest_gfs_cycle
...
opendap_url = get_gfs_opendap_url(datetime.utcnow(), cycle) # Get the OPeNDAP URL for the latest cycle
...
world = load_country_borders('country_borders_temp/ne_110m_admin_0_countries.shp')
